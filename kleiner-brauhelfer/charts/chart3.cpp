    ...
    ChartBase(parent)
{
    ...
    lblValueY1->setColor(palette().color(QPalette::WindowText));
    ...
    lblValueY2->setColor(palette().color(QPalette::WindowText));
    ...
    lblValueY3->setColor(palette().color(QPalette::WindowText));
