...
class LIB_EXPORT SudObject : public QObject
{
    ...
    Q_PROPERTY_SUD_READONLY(double, MengeSollAnstellen, toDouble())
    Q_PROPERTY_SUD_READONLY(double, MengeSollKochende, toDouble())
    Q_PROPERTY_SUD_READONLY(double, MengeSollKochbeginn, toDouble())
    Q_PROPERTY_SUD_READONLY(double, MengeSollVerdampfung, toDouble())
    Q_PROPERTY_SUD_READONLY(double, MengeSollHgf, toDouble())
    ...
    Q_PROPERTY_SUD_READONLY(double, SWAnteilMalz, toDouble())
    Q_PROPERTY_SUD_READONLY(double, SWAnteilZusatzMaischen, toDouble())
    Q_PROPERTY_SUD_READONLY(double, SWAnteilZusatzKochen, toDouble())
    Q_PROPERTY_SUD_READONLY(double, SWAnteilZusatzGaerung, toDouble())
    Q_PROPERTY_SUD_READONLY(double, SWAnteilHefestarter, toDouble())
    Q_PROPERTY_SUD_READONLY(double, SWAnteilZutaten, toDouble())
    Q_PROPERTY_SUD_READONLY(double, SRESoll, toDouble())
    Q_PROPERTY_SUD_READONLY(double, AlkoholSoll, toDouble())
