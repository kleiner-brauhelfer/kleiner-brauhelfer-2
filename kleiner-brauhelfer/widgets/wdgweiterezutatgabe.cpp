...
void WdgWeitereZutatGabe::updateValues(bool full)
{
    ...
    if (typ == Brauhelfer::ZusatzTyp::Hopfen)
        rowRohstoff = bh->modelHopfen()->getRowWithValue(ModelHopfen::ColBeschreibung, zusatzname);
    else
        rowRohstoff = bh->modelWeitereZutaten()->getRowWithValue(ModelWeitereZutaten::ColBeschreibung, zusatzname);
