    ...
    ui(new Ui::TabSud)
{
    ...
    connect(bh, &Brauhelfer::modified, this, &TabSud::updateValues);
    connect(bh, &Brauhelfer::discarded, this, &TabSud::sudLoaded);
    connect(bh->sud(), &SudObject::loadedChanged, this, &TabSud::sudLoaded);
    connect(bh->sud(), &SudObject::dataChanged, this, &TabSud::sudDataChanged);

    connect(bh->sud()->modelMaischplan(), &ProxyModel::layoutChanged,this, &TabSud::rasten_modified);
    connect(bh->sud()->modelMaischplan(), &ProxyModel::rowsInserted, this, &TabSud::rasten_modified);
    connect(bh->sud()->modelMaischplan(), &ProxyModel::rowsRemoved, this, &TabSud::rasten_modified);
    connect(bh->sud()->modelMaischplan(), &ProxyModel::dataChanged, this, &TabSud::updateMaischplan);

    connect(bh->sud()->modelMalzschuettung(), &ProxyModel::layoutChanged, this, &TabSud::malzGaben_modified);
    connect(bh->sud()->modelMalzschuettung(), &ProxyModel::rowsInserted, this, &TabSud::malzGaben_modified);
    connect(bh->sud()->modelMalzschuettung(), &ProxyModel::rowsRemoved, this, &TabSud::malzGaben_modified);
    connect(bh->sud()->modelMalzschuettung(), &ProxyModel::dataChanged, this, &TabSud::updateMalzGaben);

    connect(bh->sud()->modelHopfengaben(), &ProxyModel::layoutChanged, this, &TabSud::hopfenGaben_modified);
    connect(bh->sud()->modelHopfengaben(), &ProxyModel::rowsInserted, this, &TabSud::hopfenGaben_modified);
    connect(bh->sud()->modelHopfengaben(), &ProxyModel::rowsRemoved, this, &TabSud::hopfenGaben_modified);
    connect(bh->sud()->modelHopfengaben(), &ProxyModel::dataChanged, this, &TabSud::updateHopfenGaben);

    connect(bh->sud()->modelHefegaben(), &ProxyModel::layoutChanged, this, &TabSud::hefeGaben_modified);
    connect(bh->sud()->modelHefegaben(), &ProxyModel::rowsInserted, this, &TabSud::hefeGaben_modified);
    connect(bh->sud()->modelHefegaben(), &ProxyModel::rowsRemoved, this, &TabSud::hefeGaben_modified);

    connect(bh->sud()->modelWeitereZutatenGaben(), &ProxyModel::layoutChanged, this, &TabSud::weitereZutatenGaben_modified);
    connect(bh->sud()->modelWeitereZutatenGaben(), &ProxyModel::rowsInserted, this, &TabSud::weitereZutatenGaben_modified);
    connect(bh->sud()->modelWeitereZutatenGaben(), &ProxyModel::rowsRemoved, this, &TabSud::weitereZutatenGaben_modified);
    connect(bh->sud()->modelWeitereZutatenGaben(), &ProxyModel::dataChanged, this, &TabSud::updateExtrakt);

    connect(bh->sud()->modelWasseraufbereitung(), &ProxyModel::layoutChanged, this, &TabSud::wasseraufbereitung_modified);
    connect(bh->sud()->modelWasseraufbereitung(), &ProxyModel::rowsInserted, this, &TabSud::wasseraufbereitung_modified);
    connect(bh->sud()->modelWasseraufbereitung(), &ProxyModel::rowsRemoved, this, &TabSud::wasseraufbereitung_modified);

    connect(bh->sud()->modelAnhang(), &ProxyModel::layoutChanged, this, &TabSud::anhaenge_modified);
    connect(bh->sud()->modelAnhang(), &ProxyModel::rowsInserted, this, &TabSud::anhaenge_modified);
    connect(bh->sud()->modelAnhang(), &ProxyModel::rowsRemoved, this, &TabSud::anhaenge_modified);
...
void TabSud::saveSettings()
{
    gSettings->beginGroup(staticMetaObject.className());
    gSettings->endGroup();
}

void TabSud::restoreView()
{
    /*
...
void TabSud::modulesChanged(Settings::Modules modules)
{
    /*
...
void TabSud::sudDataChanged(const QModelIndex& index)
{
    switch (index.column())
    {
...
int TabSud::checkRohstoffeDialog(Brauhelfer::RohstoffTyp typ, const QString& name)
{
    QString msg;
    switch(typ)
    {
...
void TabSud::on_btnRastenUebernehmen_clicked()
{
...
void TabSud::on_btnMaischplanAusgleichen_clicked()
{
...
void TabSud::on_btnMaischplanFaktorAnpassen_clicked()
{
    ProxyModel *model = bh->sud()->modelMaischplan();
    double totalProzent = 0;
    for (int i = 0; i < model->rowCount(); ++i)
...
void TabSud::on_btnMaischplanAusgleichenMalz_clicked()
{
    ProxyModel *model = bh->sud()->modelMaischplan();
    double totalProzent = 0;
    for (int i = 0; i < model->rowCount(); ++i)
...
void TabSud::malzGaben_modified()
{
...
void TabSud::on_btnMalzGabenUebernehmen_clicked()
{
...
void TabSud::on_btnNeueZusatzGabeMaischen_clicked()
{
...
void TabSud::on_btnZusazGabenUebernehmenMaischen_clicked()
{
...
void TabSud::on_btnMalzAusgleichen_clicked()
{
...
void TabSud::on_btnShaAnpassen_clicked()
{
    ProxyModel *model = bh->sud()->modelMalzschuettung();
    double schuettung = 0;
    for (int i = 0; i < model->rowCount(); ++i)
...
void TabSud::hopfenGaben_modified()
{
...
void TabSud::on_btnNeueHopfenGabe_clicked()
{
...
void TabSud::on_btnHopfenGabenUebernehmen_clicked()
{
...
void TabSud::on_btnNeueZusatzGabeKochen_clicked()
{
    DlgRohstoffAuswahl dlg(Brauhelfer::RohstoffTyp::Zusatz, this);
    if (dlg.exec() == QDialog::Accepted)
    {
...
void TabSud::on_btnZusazGabenUebernehmenKochen_clicked()
{
...
void TabSud::on_cbBerechnungsartHopfen_currentIndexChanged(int index)
{
    if (ui->cbBerechnungsartHopfen->hasFocus())
    {
...
void TabSud::on_btnHopfenAusgleichen_clicked()
{
...
void TabSud::hefeGaben_modified()
{
...
void TabSud::on_btnNeueHefeGabe_clicked()
{
...
void TabSud::vergaerungsgradUebernehmen(const QString& hefe)
{
...
void TabSud::on_btnHefeGabenUebernehmen_clicked()
{
...
void TabSud::on_btnNeueHopfenGabeGaerung_clicked()
{
    DlgRohstoffAuswahl dlg(Brauhelfer::RohstoffTyp::Hopfen, this);
    if (dlg.exec() == QDialog::Accepted)
    {
...
void TabSud::on_btnHopfenGabenUebernehmenGaerung_clicked()
{
...
void TabSud::on_btnNeueZusatzGabeGaerung_clicked()
{
    DlgRohstoffAuswahl dlg(Brauhelfer::RohstoffTyp::Zusatz, this);
    if (dlg.exec() == QDialog::Accepted)
    {
...
void TabSud::on_btnZusazGabenUebernehmenGaerung_clicked()
{
...
void TabSud::weitereZutatenGaben_modified()
{
    int nLayout;
    int nMaischen = 0;
    int nKochen = 0;
...
void TabSud::wasseraufbereitung_modified()
{
...
void TabSud::on_btnNeueWasseraufbereitung_clicked()
{
...
void TabSud::on_btnWasseraufbereitungUebernehmen_clicked()
{
...
void TabSud::on_btnNeuerAnhang_clicked()
{
...
void TabSud::on_cbAnlage_currentTextChanged(const QString &value)
{
    if (ui->cbAnlage->hasFocus())
        gUndoStack->push(new SetModelDataCommand(bh->modelSud(), bh->sud()->row(), ModelSud::ColAnlage, value));
}

void TabSud::on_btnSudhausausbeute_clicked()
{
    WidgetDecorator::suspendValueChangedClear = true;
...
void TabSud::on_btnVerdampfungsrate_clicked()
{
    WidgetDecorator::suspendValueChangedClear = true;
...
void TabSud::on_cbWasserProfil_currentTextChanged(const QString &value)
{
    if (ui->cbWasserProfil->hasFocus())
        gUndoStack->push(new SetModelDataCommand(bh->modelSud(), bh->sud()->row(), ModelSud::ColWasserprofil, value));
}

void TabSud::on_btnWasserProfil_clicked()
{
...
void TabSud::on_btnTagNeu_clicked()
{
...
void TabSud::on_btnTagUebernehmen_clicked()
{
...
void TabSud::on_btnTagLoeschen_clicked()
{
    ProxyModel *model = bh->sud()->modelTags();
