    ...
    mRowBewertung(-1)
{
    ...
    table->appendCol({ModelSud::ColSudname, true, false, 200, new SudNameDelegate(table)});
    ...
    table->appendCol({ModelSud::ColBewertungMittel, true, false, 80, new RatingDelegate(table)});
    table->build();
