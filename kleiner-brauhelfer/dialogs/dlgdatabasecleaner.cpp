    ...
    ui(new Ui::DlgDatabaseCleaner)
{
    ...
    mTestFncs = {
        ...
        [this](){return this->testNullField(bh->modelMalz(), { ModelMalz::ColBeschreibung}, 0);},
        [this](){return this->testNullField(bh->modelHopfen(), {ModelHopfen::ColBeschreibung}, 0);},
        [this](){return this->testNullField(bh->modelHefe(), {ModelHefe::ColBeschreibung}, 0);},
        [this](){return this->testNullField(bh->modelWeitereZutaten(), {ModelWeitereZutaten::ColBeschreibung}, 0);},
