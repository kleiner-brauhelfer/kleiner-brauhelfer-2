...
void FilterButtonSud::setModel(ProxyModelSud* model, Items items)
{
    ...
    if (items.testFlag(Item::Status))
    {
        ...
        pal.setColor(QPalette::Base, gSettings->colorRezept);
        ...
        pal.setColor(QPalette::Base, gSettings->colorGebraut);
        ...
        pal.setColor(QPalette::Base, gSettings->colorAbgefuellt);
        ...
        pal.setColor(QPalette::Base, gSettings->colorAusgetrunken);
    ...
    if (items.testFlag(Item::Merkliste))
    {
        ...
        pal.setColor(QPalette::Base, gSettings->colorMerkliste);
