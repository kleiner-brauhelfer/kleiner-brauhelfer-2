...
double BierCalc::convertGravity(BierCalc::GravityUnit srcunit ,BierCalc::GravityUnit destunit, double value) {
  double retval=-1;
  switch (srcunit)
    {
      case BierCalc::GravityUnit::Plato:
        switch (destunit)
          {
          case BierCalc::GravityUnit::SG:
            retval = BierCalc::platoToDichte(value);
            break;
          case BierCalc::GravityUnit::Brix:
